...
| [`client-ui-agents`](../packages/client/ui-agents) | `client` | [`client-locale`](../packages/client/locale), [`client-ui-sidebar`](../packages/client/ui-sidebar), [`client-ui-slots`](../packages/client/ui-slots), [`invariants`](../packages/runtime-diagnostics/invariants) |
| [`client-ui-settings-weixin`](../packages/client/ui-settings-weixin) | `client` | [`client-locale`](../packages/client/locale), [`client-ui-settings`](../packages/client/ui-settings), [`client-ui-slots`](../packages/client/ui-slots), [`invariants`](../packages/runtime-diagnostics/invariants) |
