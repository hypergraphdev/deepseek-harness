...
| `event:agent/inbox/spliced` | event | `40972d0ee4160f612b82b8c77ba6f087dd328aa739c9cfeae0ced8fb67e283f9` | [`event:agent/inbox/spliced`](#persistence-type-eventagentinboxspliced) |
...
| `event:session/title-llm-request` | event | `1f3ebc4bbfee4f226c4dcfcd147deb269cf70bfbc939da8c975ab54da7060480` | [`event:session/title-llm-request`](#persistence-type-eventsessiontitle-llm-request) |
...
| `event:user/message` | event | `4a13de9bd4a11d0104f1d3e82e2947c4ddf12a412cf84362b6a6530ce1e7ece7` | [`event:user/message`](#persistence-type-eventusermessage) |
...
SHA-256: `40972d0ee4160f612b82b8c77ba6f087dd328aa739c9cfeae0ced8fb67e283f9`
...
SHA-256: `766f8bfb925f2d97471c53f8d393f907a43c0ab30cf7842f11dddaaf6a4f73f3`
...
SHA-256: `11c5695e9772d504855e1a6cfa4adfc3307a530232918d74aea6bf62603a9f16`
...
SHA-256: `45ee739d7f974432eff87ca3c0f4be610464b68eb08edd51cca1b9a98bb7832e`

Sources: [`packages/api/session-controller/src/types.ts:400`](../packages/api/session-controller/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `browserPage` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[10].browserPage`](#persistence-type-eventagentinboxspliceddatainserted0source10browserpage) |
| `clientTimeZone` | optional | `string` |
| `kind` | required | `"user"` |
| `rpcId` | required | `string` |

<a id="persistence-type-eventagentinboxspliceddatainserted0source10browserpage"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[10].browserPage`

SHA-256: `204fb58b1f1985258c0e313cd40271e8280baef52d48897d074910be87d74e59`

One of:

- [`packages/api/session-controller/src/types.ts#PromptBrowserPage`](#persistence-type-packagesapisession-controllersrctypestspromptbrowserpage)
- `null`
...
SHA-256: `1f3ebc4bbfee4f226c4dcfcd147deb269cf70bfbc939da8c975ab54da7060480`
...
SHA-256: `286fcdf66894ec764aa2f6ca9ad6185a063f9f6de98de26b6fbf5448b6c44f8b`
...
SHA-256: `4a13de9bd4a11d0104f1d3e82e2947c4ddf12a412cf84362b6a6530ce1e7ece7`
...
<a id="persistence-type-packagesapisession-controllersrctypestspromptbrowserpage"></a>

### `packages/api/session-controller/src/types.ts#PromptBrowserPage`

SHA-256: `a5fb1d7028bfab9f5bedae083877f1dbb30de3637cc0d30f4333195fdda564f8`

Sources: [`packages/api/session-controller/src/types.ts:316`](../packages/api/session-controller/src/types.ts)
...
SHA-256: `69cb0b3017de8426fec690cf9085ed74cf71309f253b0130e20a0829d2d7ae63`
...
SHA-256: `fd5f5e3eb6c3ef05a1514c5ca9ac7b03cdaf0d3f994f1c69c4dbd2e23c5825ce`
...
SHA-256: `29c50d71c473742994e70700a041dad1a33fbdde748fb521e596b7447a39d578`
...
SHA-256: `08f5a26049daf3b50689486d50ff54453fa896d16a93791bdabd70813056b509`
...
Sources: [`packages/api/session-controller/src/types.ts:395`](../packages/api/session-controller/src/types.ts) · [`packages/attachment/attachment/src/brand.ts:6`](../packages/attachment/attachment/src/brand.ts) · [`packages/compaction/compaction/src/brand.ts:4`](../packages/compaction/compaction/src/brand.ts) · [`packages/core/session/src/types.ts:19`](../packages/core/session/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:20`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:32`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:8`](../packages/experimental/agent-team/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:14`](../packages/feedback/message-feedback/src/types.ts) · [`packages/goal/goal/src/types.ts:17`](../packages/goal/goal/src/types.ts) · [`packages/interaction/commands/src/brand.ts:31`](../packages/interaction/commands/src/brand.ts) · [`packages/interaction/user-approval/src/types.ts:17`](../packages/interaction/user-approval/src/types.ts) · [`packages/llm/llm-retry/src/brand.ts:4`](../packages/llm/llm-retry/src/brand.ts) · [`packages/llm/llm/src/brand.ts:16`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:31`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:43`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:67`](../packages/llm/llm/src/brand.ts) · [`packages/schedule/schedule/src/types.ts:10`](../packages/schedule/schedule/src/types.ts) · [`packages/session/session-title/src/index.ts:42`](../packages/session/session-title/src/index.ts) · [`packages/session/session-title/src/types.ts:17`](../packages/session/session-title/src/types.ts) · [`packages/webhook/webhook/src/brand.ts:12`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:6`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:9`](../packages/webhook/webhook/src/brand.ts) · [`packages/workflow/workflow/src/types.ts:13`](../packages/workflow/workflow/src/types.ts)
